...
else
{
    ...
    Try 
    {
        ...
        $manifestPath = '.\GithubTools\GithubTools.psd1'
    ...
    Try 
    {
        ...
        Publish-Module @PM
        Write-Host "GithubTools PowerShell Module version $newVersion published to the PowerShell Gallery." -ForegroundColor Cyan
    }
    Catch 
    {
        # Sad panda; it broke
    ...
    Try 
    {
        ...
        Write-Host "GithubTools PowerShell Module version $newVersion published to GitHub." -ForegroundColor Cyan
    }
    Catch 
    {
        # Sad panda; it broke
